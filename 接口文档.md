...
**接口地址**:`/api/chatHistory/list/page`
...
**接口地址**:`/api/chatHistory/app/list/page`
...
| 参数名称 | 参数说明 | 请求类型    | 是否必须 | 数据类型 | schema |
| -------- | -------- | ----- | -------- | -------- | ------ |
|appUserUpdateRequest|AppUserUpdateRequest|body|true|AppUserUpdateRequest|AppUserUpdateRequest|
|&emsp;&emsp;id|||false|integer(int64)||
...
| 参数名称 | 参数说明 | 请求类型    | 是否必须 | 数据类型 | schema |
| -------- | -------- | ----- | -------- | -------- | ------ |
|appUserQueryRequest|AppUserQueryRequest|body|true|AppUserQueryRequest|AppUserQueryRequest|
|&emsp;&emsp;pageNum|||false|integer(int32)||
|&emsp;&emsp;pageSize|||false|integer(int32)||
|&emsp;&emsp;sortField|||false|string||
|&emsp;&emsp;sortOrder|||false|string||
